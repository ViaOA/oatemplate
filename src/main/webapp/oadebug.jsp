...
<%
    ...
    if (true) {
        System.out.println("oadebug.jsp ----------------- START -------------");
...
// example:
//    http://localhost:8081/oadebug.jsp?oaform=formMyAccountServiceAward    
        
        System.out.println("DEBUG for FormId="+id+"="+form.getDebug()+", forward="+forwardPage);
