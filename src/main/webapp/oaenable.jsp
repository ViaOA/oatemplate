...
<%
    ...
    if (true) {
        System.out.println("oaenable.jsp ----------------- START -------------");
    ...
    if (form == null) {
        form = (OAForm) oasession.get("oaformLast");
...
// example:
//    http://localhost:8081/oaenable.jsp?oaform=formMyAccountServiceAward    
        
        System.out.println("ENABLE for FormId="+id+"="+form.getEnabled()+", forward="+forwardPage);
