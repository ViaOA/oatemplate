...
/**
 * 
 * Embedded Jetty webserver that supports: http, https, webservices (jax-ws), servlets, JSP, file explorer, NCSARequestLog logging
 * Servlets for:  REST/json, pdf, images, security, jnlp 
 *
 ...
 *       
 * precompiling jsp      
 *    https://www.eclipse.org/jetty/documentation/9.4.x/jetty-jspc-maven-plugin.html
 *    
 * 
 * 20180201 updated to support for Jetty 9.4.8.v20171121, previous version was 7.6.0
 * 
 * @author vincevia
 */
...
//qqq comment out        
        ...
        */
        ...
        handlerList.setHandlers(new Handler[] { requestLogHandler, httpsRedirectHandler, redirectHandler, servletContextHandler, resourceHandler, new DefaultHandler() });
        ...
        /**
         * Since we will use Jetty to handle connections for jax-ws, to support webservices, must use
         * ContextHandlerCollection (not HandlerList)
         * 
         * see: http://docs.codehaus.org/display/JETTY/J2se6HttpServerSPI see:
         * http://javasourcecode.org/html/open-source/jetty/jetty-7.4.4.v20110707
         * org/mortbay/jetty/j2sehttpspi/JettyHttpServer.java.html
    ...
    /**
     * Add a webservice that will be published and controlled by jax-ws + Jetty.
     * 
     * example: String urlWebserviceQuickbook = "https://www.viaoaapp.com:8443/ws/quickbooks";
     * jc.addWebservice(urlWebserviceQuickbook, wsc.getWebService());
     * 
     * WSDL: https://www.viaoaapp.com:8443/ws/quickbooks?WSDL
     * 
     * @param urlWebService
     *            url to register the webservice under.
     * @param webservice
     */
    public void addWebservice(String urlWebService, Object webservice) {
        LOG.fine("urlWebService=" + urlWebService);
        if (urlWebService == null) return;
    ...
    /** 20180201 https://github.com/jetty-project/embedded-jetty-jsp/blob/master/src/main/java/org/eclipse/jetty/demo/Main.java
     * JspStarter for embedded ServletContextHandlers
     * 
     * This is added as a bean that is a jetty LifeCycle on the ServletContextHandler.
     * This bean's doStart method will be called as the ServletContextHandler starts,
     * and will call the ServletContainerInitializer for the jsp engine.  (required by tomcat lib)
     */
     ...
     * 
     * // to get a directory (under "webcontent") http://localhost:8081/data => webcontent/data
     * 
     * // to access lib directory http://localhost:8081/lib
     * 
     * // ex for webservice http://localhost:8081/ws/quickbooks?wsdl
