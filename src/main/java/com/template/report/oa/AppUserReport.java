...
public class AppUserReport {
    private static Logger LOG = Logger.getLogger(AppUserReport.class.getName());
...
*/    
    ...
    public AppUserReport(Window windowParent) {
        ...
        if (report == null) {
            report = new OAHTMLReport(getHTMLTextPane()) {
                ...
                protected String getValue(String defaultValue, OAObject obj, String propertyName, int width, String fmt, OAProperties props) {
                    return AppUserReport.this.getValue(defaultValue, obj, propertyName, width, fmt, props);
                }
                @Override
                public OAProperties getProperties() {
                    return AppUserReport.this.getProperties();
                }
            };
        }
        return report;
    ...
    public void init() {
        ...
        try {
            ...
            detail = OAFile.readTextFile(this.getClass(), "/com/template/report/html/oa/user.html", 1024 * 3);
        }
        catch (Exception e) {
        ...
        */
        ...
        SwingWorker<Boolean, String> sw = new SwingWorker<Boolean, String>() {
            ...
            protected Boolean doInBackground() throws Exception {
                try {
                    getPdfController().saveToPdf(getPrintController().getPrintable(), getPrintController().getPageFormat(), fileName, "Template Report", "");
                    bValid = true;
                }
                catch (Exception e) {
                    bValid = false;
...
/*qqq                
                if (pf != report.getPageFormat()) {
                    ...
                    AppUserReport.this.savePageFormat(report);
                }
*/                
    ...
    public static void main(String[] args) throws Exception {
        ...
        AppUserReport ur = new AppUserReport(frm);
        ur.init();
