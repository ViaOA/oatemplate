    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.template.webservice.client.hello.wsimport.HelloService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.template.webservice.client.hello.wsimport.HelloService.class.getResource(".");
