...
import com.template.model.oa.ReportDef;
...
public class ReportDefJfcBase implements OAModelJfcInterface {
    protected static Logger LOG = Logger.getLogger(ReportDefJfc.class.getName());
    
    public static final String PP_Display    = OAString.cpp(ReportDef.P_Name);
    ...
    // Model
    protected ReportDefModel model;
    ...
    // Search
    protected ReportDefSearchJfc jfcSearch;
    // hub Search
    protected ReportDefSearchJfc jfcSearchHub;
    // Add
    protected ReportDefSearchJfc jfcAdd;
    
    
    // focus components
    protected OADateTimeTextField dttxtCreated;
    protected OADateTimeTextField tableDtTxtCreated;
    protected ReportClassJfc jfcReportClass;
    
    public ReportDefJfcBase() {
        this.model = new ReportDefModel();
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    
    public ReportDefJfcBase(Hub<ReportDef> hubReportDef) {
        this.model = new ReportDefModel(hubReportDef);
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    public ReportDefJfcBase(ReportDefModel modelReportDef) {
        if (modelReportDef == null) this.model = new ReportDefModel();
        else this.model = modelReportDef;
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    ...
    // Model
    public ReportDefModel getModel() {
        return model;
    }
    ...
    public static Icon getIcon() {
        return Resource.getJarIcon("reportDef.gif");
    }
    public static Icon getTitleIcon() {
        return Resource.getJarIcon("reportDefs.gif");
    }
    ...
    public OAMenuItem createNewMenuItem(Hub<ReportDef> hub) {
        if (!getModel().getAllowNew()) return null;
        OAMenuItem mi = new OAMenuItem(hub, OAMenuItem.NEW) {
            @Override
            public void afterActionPerformed() {
                // ReportDefJfcBase.this.getEditDialog(this).setVisible(true);
                ReportDefJfcBase.this.onNewReportDefCreated();
    ...
    public OAMenuItem createInsertMenuItem(Hub<ReportDef> hub) {
        if (!getModel().getAllowNew()) return null;
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<ReportDef> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        if (hubRoot == null && OAString.isEmpty(leadingPropertyPath)) {
            hubRoot = getModel().getHub();
        }
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, ReportDef.P_Name), hubRoot, getHub()) {
            @Override
            public void objectSelected(Object obj) {
                super.objectSelected(obj);
                ReportDefJfcBase.this.getCardPanel();
                ReportDefJfcBase.this.onShowEditPanel();
            }
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                ReportDefJfcBase.this.onDoubleClickTreeNode();
            }
            @Override
    ...
    public OAMenuItem createSearchMenuItem() {
        ...
        OAMenuItem mi = new OAMenuItem(getHub(), getModel().getDisplayName() + " search ...", Resource.getJarIcon("search.gif"), OAButton.SEARCH) {
            ...
            public Object getSearchObject() {
                ReportDef reportDef = ReportDefJfcBase.this.onSearch();
                return reportDef;
            }
            @Override
            public void afterActionPerformed() {
    ...
    public JMenuItem createHubSearchMenuItem() {
        ...
        mi.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ReportDefJfcBase.this.onHubSearch();
           }
        });
        return mi;
    }
    ...
    public OALabel createLabel() {
        OALabel lbl = new OALabel(getHub(), OAString.cpp(ReportDef.P_Name), 15) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                ReportDefJfcBase.this.customizeRenderer(lbl, ReportDefJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
            @Override
            public String getToolTipText(Object object, int row, String defaultValue) {
                return ReportDefJfcBase.this.getToolTipText(ReportDefJfcBase.this.getHub().getAt(row), row, defaultValue);
            }
        };
    ...
    protected void customizeRenderer(JLabel lbl, ReportDef reportDef, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
    }
    protected String getToolTipText(ReportDef reportDef, int row, String defaultValue) {
        return defaultValue;
    }
    ...
    public OAComboBox createComboBox() {
        OAComboBox cbo = new OAComboBox(getHub(), OAString.cpp(ReportDef.P_Name), 15) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                ReportDefJfcBase.this.customizeRenderer(lbl, ReportDefJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
    ...
    public OAList createList() {
        OAList lst = new OAList(getHub(), OAString.cpp(ReportDef.P_Name), 12, 15) {
            @Override
            public void customizeRenderer(JLabel label, JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                ReportDefJfcBase.this.customizeRenderer(label, ReportDefJfcBase.this.getHub().getAt(index), isSelected, cellHasFocus, index, false, false);
            }
        };
    ...
    public OATree createSearchTree() {
        ...
        tnode.setIcon(ReportDefJfc.getTitleIcon());
        tree.add(tnode);
        node = new OATreeNode(ReportDefJfc.PP_Display, getHub()) {
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                ReportDefJfcBase.this.onDoubleClickTreeNode();
            }
        ...
        node.setIcon(ReportDefJfc.getIcon());
        node.setForegroundColorProperty(ReportDefJfc.PP_ForeColor);
        node.setBackgroundColorProperty(ReportDefJfc.PP_BackColor);
        node.setIconColorProperty(ReportDefJfc.PP_IconColor);
        node.setImageProperty(ReportDefJfc.PP_Icon);
        node.setFontProperty(ReportDefJfc.PP_Font);
        node.setMaxImageHeight(20);
        node.setMaxImageWidth(32);
        tnode.add(node);
        return tree;
    ...
    protected String getToolTipText(OATable table, int row, int col, String defaultValue) {
        // ReportDef client = (ReportDef) table.getHub().getAt(row);
        // defaultValue = ReportDefDelegate.getToolTipText(client, true);
        return defaultValue;
    }
    public OATable createTable() {
        Hub<ReportDef> hubTable;
        if (getModel().getAllowTableFilter()) hubTable = new Hub<ReportDef>(ReportDef.class);
        ...
        OATable table = new OATable(hubTable) {
            ...
            public void onDoubleClick() {
                if (ReportDefJfcBase.this.getModel().getAllowGotoEdit()) {
                    ReportDefJfcBase.this.getEditDialog(this).setVisible(true);
                }
            }
        };
        ...
        // table.setColumnProperties(ModelDelegate.getProperties(), "ReportDef");
    ...
    public void createTableColumns(OATable table) {
        OALabel lbl;
        OATableColumn tc;
        if (getModel().getReportClassModel().getCreateUI()) {
            OALabel olbl = createReportClassLabel();
            olbl.setToolTipText("Report Class");
            tc = table.addColumn("Report Class", 18, olbl);
            if (getModel().getAllowTableFilter()) {
                tc.setFilterComponent(new OATextFieldFilter(OAString.cpp(ReportDef.P_ReportClass, ReportClass.P_Name)));
            }
        }
        tc = table.addColumn("Name", 15, createNameTextField());
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(ReportDef.P_Name));
        }
    }
    ...
    protected void createReadOnlyTableColumns(OATable table) {
        OALabel lbl;
        OATableColumn tc;
        lbl = new OALabel(getHub(), OAString.cpp(ReportDef.P_ReportClass, ReportClass.P_Name));
        lbl.setToolTipText("Report Class");
        if (ReportClassJfc.PP_IconColor != null) {
            lbl.setIconColorProperty(OAString.cpp(ReportDef.P_ReportClass) + "." + ReportClassJfc.PP_IconColor);
        }
        if (ReportClassJfc.PP_Icon != null) {
            lbl.setImageProperty(OAString.cpp(ReportDef.P_ReportClass) + "." + ReportClassJfc.PP_Icon);
        }
        tc = table.addColumn("Report Class", 18, lbl);
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(OAString.cpp(ReportDef.P_ReportClass, ReportClass.P_Name)));
        }
        lbl = new OALabel(getHub(), ReportDef.P_Name, 15);
    ...
    public void updateToolBar(final JToolBar toolBar, final ToolBarOptions tbo) {
        ...
        if (tbo.bLabel) {
            OALabel lbl = new OALabel(getHub(), OAString.cpp(ReportDef.P_Name));
            lbl.setToolTipTextPropertyPath(OAString.cpp(ReportDef.P_Name));
            lbl.setMaxCols(20);
            lbl.setFont(lbl.getFont().deriveFont(Font.ITALIC));
    ...
    public JButton createGotoListButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ReportDefJfcBase.this.showCardPanel(ReportDefJfcBase.this.CARD_List);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createDownloadButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ReportDefJfcBase.this.onDownload();
            }
        });
    ...
    protected void onDownload() {
        DownloadDialog dd = new DownloadDialog<ReportDef>(getHub());
        addDownloadProperties(dd);
        dd.download();
    }
    protected void addDownloadProperties(DownloadDialog dd) {
        dd.addProperty("Id", ReportDef.P_Id);
        dd.addProperty("reportClass.id", ReportDefPP.reportClass().id());
        dd.addProperty("reportClass.name", ReportDefPP.reportClass().name());
        dd.addProperty("name", ReportDef.P_Name);
    }
    // Card Panel
    ...
    public JPanel createEditPanel(JTabbedPane tabbedPane, final boolean bUseCombinedDetail) {
        ...
        tabbedPane.addTab("Template", icon, createTemplateHTMLTextPanel(), null);
        panel = panMain;
        return panel;
    }
    ...
    public JDialog getEditDialog(Component comp) {
        ...
        ReportDefJfc jfc = new ReportDefJfc(getModel());
    ...
    public OALabel createIdLabel() {
        OALabel lbl = new OALabel(getHub(), ReportDef.P_Id, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OADateTimeTextField createCreatedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), ReportDef.P_Created, 15);
    ...
    public OATextField createNameTextField() {
        OATextField txt = new OATextField(getHub(), ReportDef.P_Name, 15);
    ...
    public OALabel createTemplateLabel() {
        OALabel lbl = new OALabel(getHub(), ReportDef.P_Template, 20);
        lbl.setVerticalAlignment(SwingConstants.TOP);
        return lbl;
    }
    
    public OALabel createSeqLabel() {
        OALabel lbl = new OALabel(getHub(), ReportDef.P_Seq, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OALabel createReportClassLabel() {
        OALabel lbl = getReportClassJfc().createLabel();
        return lbl;
    }
    public JButton createReportClassCommand() {
        JButton cmd = null;
        return null;
    }
    ...
    public ReportClassJfc getReportClassJfc() {
        if (jfcReportClass != null) return jfcReportClass;
        jfcReportClass = new ReportClassJfc(getModel().getReportClassSelectFromModel()) {
        };
        jfcReportClass.setLevel(getLevel()+1);
        OAModelJfcUtil.setParent(jfcReportClass, this);
        return jfcReportClass;
    }
    // OnShowCommands
    ...
    protected void onNewReportDefCreated() {
        onShowEditPanel();
    ...
    // Inner Search
    public ReportDefSearchJfc getSearchHubJfc() {
        if (jfcSearchHub != null) return jfcSearchHub;
        ReportDefSearchModel modelSearch = new ReportDefSearchModel();
        modelSearch.setSearchFromHub(getHub());
        jfcSearchHub = new ReportDefSearchJfc(modelSearch, true, getModel().getAllowMultiSelect()) {
            @Override
    ...
    protected void onHubSearch() {
        ...
        if (getModel().getAllowMultiSelect()) {
            ...
            for (ReportDef reportDef : getSearchHubJfc().getModel().getMultiSelectHub()) {
                if (getHub().contains(reportDef)) {
                    getModel().getMultiSelectHub().add(reportDef);
                }
            }
            getHub().setAO(getModel().getMultiSelectHub().getAt(0));
        }
        else {
            ReportDef reportDef = getSearchHubJfc().getSelected();
            if (reportDef != null) {
                if (getHub().contains(reportDef)) {
                    getHub().setAO(reportDef);
                }
            }
        }
    }
    ...
    protected ReportDefSearchJfc getSearchJfc() {
        if (jfcSearch == null) {
            jfcSearch = new ReportDefSearchJfc();
        }
        return jfcSearch;
    }
    protected ReportDef onSearch() {
        getSearchJfc().getModel().beforeInput();
        getSearchJfc().getDialog().setVisible(true);
        ReportDef reportDef = null;
        if (getSearchJfc().wasSelected()) reportDef = getSearchJfc().getSelected();
        return reportDef;
    }
    // Add
    protected ReportDefSearchJfc getAddJfc() {
        if (jfcAdd == null) {
            jfcAdd = new ReportDefSearchJfc();
        }
        return jfcAdd;
    }
    protected void onAdd() {
        ...
        ReportDef reportDef = getAddJfc().getSelected();
    ...
    public static void main(String[] args) {
        ...
        ReportDefJfc ui = new ReportDefJfc() {
            @Override
            protected ReportDefSearchJfc getSearchJfc() {
                if (this.jfcSearch == null) {
                    this.jfcSearch = new ReportDefSearchJfc(false) {
                        @Override
