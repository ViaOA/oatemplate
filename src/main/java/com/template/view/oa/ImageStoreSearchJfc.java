...
public class ImageStoreSearchJfc {
    ...
    public OATextField createCustomQueryTextField() {
        OATextField txt = new OATextField(getModel().getImageStoreSearchHub(), ImageStoreSearch.P_CustomQuery, 25);
        txt.setMinimumColumns(10);
        txt.setMaximumColumns(110);
        new OATextFieldCodeController(txt, ImageStore.class, OATextFieldCodeController.Type.query);
        return txt;
    }
