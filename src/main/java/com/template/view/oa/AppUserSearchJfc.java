...
public class AppUserSearchJfc {
    ...
    public OATextField createCustomQueryTextField() {
        OATextField txt = new OATextField(getModel().getAppUserSearchHub(), AppUserSearch.P_CustomQuery, 25);
        txt.setMinimumColumns(10);
        txt.setMaximumColumns(110);
        new OATextFieldCodeController(txt, AppUser.class, OATextFieldCodeController.Type.query);
        return txt;
    }
