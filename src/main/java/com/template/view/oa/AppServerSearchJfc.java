...
public class AppServerSearchJfc {
    ...
    public OATextField createCustomQueryTextField() {
        OATextField txt = new OATextField(getModel().getAppServerSearchHub(), AppServerSearch.P_CustomQuery, 25);
        txt.setMinimumColumns(10);
        txt.setMaximumColumns(110);
        new OATextFieldCodeController(txt, AppServer.class, OATextFieldCodeController.Type.query);
        return txt;
    }
