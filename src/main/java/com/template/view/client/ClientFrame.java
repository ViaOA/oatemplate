    ...
    */
    ...
    public class DocGlassPanel extends JPanel {
        ...
        protected void processMouseEvent(MouseEvent e) {
            ...
            Location loc = new Location(pt, (al.size()+1)+"");
            al.add(loc);
            repaint();
        }
    ...
    public void showCardPanel(String name) {
        ...
        if (buttonGroup != null && hmButtonGroup != null) {
            ...
            if (tb != null) buttonGroup.setSelected(tb.getModel(), true);
        ...
        if (radioButtonMenuItemGroup != null && hmRadioButtonMenuItemGroup != null) {
            ...
            if (mi != null) radioButtonMenuItemGroup.setSelected(mi.getModel(), true);
            else radioButtonMenuItemGroup.clearSelection();
        }
    }
    ...
    public void addPanel(JComponent cardComponent, final String name, JRadioButtonMenuItem mi, JToggleButton button) {
        if (cardComponent != null) getCardPanel().add(cardComponent, name);
    ...
    public JPanel getToolbarCommandPanel() {
        if (toolbarCommandPanel != null) return toolbarCommandPanel;
        toolbarCommandPanel = new JPanel() {
            ...
            void refresh() {
                if (!abIgnore.compareAndSet(false, true)) return;
                for (;;) {
                    int x = al.size();
                    try {
                        setLayout(null);
    ...
    public JMenu getFileMenu() {
        if (menuFile != null) return menuFile;
    ...
    public JMenu getEditMenu() {
        if (menuEdit != null) return menuEdit;
