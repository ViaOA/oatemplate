	...
	protected void setup() {
		...
		AppServerJfc jfcAppServer = new AppServerJfc(hubAppServer) {
			...
			public void showCardPanel(final String name) {
				ApplicationBarBase.this.cardLayout.show(ApplicationBarBase.this.cardPanel, CARD_AppServers);
				if (panx != null) {
				...
				SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
					...
					protected void done() {
						if (ex != null) {
							...
							JOptionPane.showMessageDialog(	null, "Exception while creating UI, message sent to tech support", "UI Exception",
															JOptionPane.ERROR_MESSAGE);
						}
						if (panx == null) {
							panx = new JPanel();
						}
						ApplicationBarBase.this.cardPanel.add(panx, CARD_AppServers);
						showCardPanel(name);
					}
				};
				sw.execute();
		...
		jfcAppServer.getModel().setPluralDisplayName("App Servers");
		...
		jfcAppServer.getModel().setAllowNew(true);
		ttNode = jfcAppServer.getTreeTitleNode();
		tree.add(ttNode);
		ttNode.add(jfcAppServer.getTreeNode());
		cardPanel.add(new JLabel("loading App Servers ...", Resource.getJarIcon("wait.png"), JLabel.CENTER), CARD_AppServers);
		...
		// AppUserLogins - App Users Last Day App User Logins
		...
		jfcAppUserLogin.getModel().setPluralDisplayName("App Users Last Day App User Logins");
		...
		tree.add(ttNode);
		cardPanel.add(	new JLabel("loading App Users Last Day App User Logins ...", Resource.getJarIcon("wait.png"), JLabel.CENTER),
						CARD_AppUserLogins);

		// AppUserErrors - App Users App User Logins App User Errors
		...
		jfcAppUserError.getModel().setPluralDisplayName("App Users App User Logins App User Errors");
		...
		tree.add(ttNode);
		cardPanel.add(	new JLabel("loading App Users App User Logins App User Errors ...", Resource.getJarIcon("wait.png"), JLabel.CENTER),
						CARD_AppUserErrors);
	}
