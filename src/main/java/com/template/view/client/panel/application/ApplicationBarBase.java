...
public class ApplicationBarBase {
    ...
    protected void setup() {
        ...
        tree.add(ttNode);
        cardPanel.add(new JLabel("loading App Users Last Day App User Logins ...", Resource.getJarIcon("wait.png"), JLabel.CENTER), CARD_AppUserLogins);
        ...
        tree.add(ttNode);
        cardPanel.add(new JLabel("loading App Users App User Logins App User Errors ...", Resource.getJarIcon("wait.png"), JLabel.CENTER), CARD_AppUserErrors);
    }
