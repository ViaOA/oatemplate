...
Create new project for OA App generated by OABuilder
    create project under /git 
        (dont generate from OABuilder yet)
    create new Eclipse "Java Project", using /git directory
	convert to maven project
		right click on project name
			choose menu itme: "Configure"
				select: "Convert to Maven Project"
    delete pom.xml
    have OABuilder generate the App
    from Eclipse menu
...
Images for JFC application
  see readme.txt in images directory
